...
export default function ShopSidebarElement({
  ...
  return (
    <Link
      href={`/${locale}/${createSlug(title, String(id))}/${rest}`}
    ...
    >
      <div className="bg-amber-400 font-light   aspect-square w-8 h-8 text-center rounded-full flex items-center justify-center">
        {title.charAt(0) || ""}
      </div>
